...
impl<'a> ServerVersionCmd<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.client_wan_ip {
            builder.add_client_wan_ip(x);
        }
        if let Some(x) = args.server_version {
            builder.add_server_version(x);
        }
    ...
    pub fn server_version(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                ServerVersionCmd::VT_SERVER_VERSION,
                None,
            )
        }
    }
    ...
    pub fn client_wan_ip(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ServerVersionCmd::VT_CLIENT_WAN_IP, None)
        }
    }
    #[inline]
    pub fn client_wan_port(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(ServerVersionCmd::VT_CLIENT_WAN_PORT, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn heart_type(&self) -> u8 {
        ...
        unsafe {
            self._tab
                .get::<u8>(ServerVersionCmd::VT_HEART_TYPE, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn heart_client_interval(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(ServerVersionCmd::VT_HEART_CLIENT_INTERVAL, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn check_server_interval(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(ServerVersionCmd::VT_CHECK_SERVER_INTERVAL, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn server_id(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(ServerVersionCmd::VT_SERVER_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn server_time_utc(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(ServerVersionCmd::VT_SERVER_TIME_UTC, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn server_time(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(ServerVersionCmd::VT_SERVER_TIME, Some(0))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ServerVersionCmdBuilder<'a, 'b, A> {
    ...
    pub fn add_client_wan_ip(&mut self, client_wan_ip: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            ServerVersionCmd::VT_CLIENT_WAN_IP,
            client_wan_ip,
        );
    }
    #[inline]
    pub fn add_client_wan_port(&mut self, client_wan_port: i32) {
        self.fbb_
            .push_slot::<i32>(ServerVersionCmd::VT_CLIENT_WAN_PORT, client_wan_port, 0);
    }
    #[inline]
    pub fn add_heart_type(&mut self, heart_type: u8) {
        self.fbb_
            .push_slot::<u8>(ServerVersionCmd::VT_HEART_TYPE, heart_type, 0);
    }
    #[inline]
    pub fn add_heart_client_interval(&mut self, heart_client_interval: u32) {
        self.fbb_.push_slot::<u32>(
            ServerVersionCmd::VT_HEART_CLIENT_INTERVAL,
            heart_client_interval,
            0,
        );
    }
    ...
    pub fn add_check_server_interval(&mut self, check_server_interval: u32) {
        self.fbb_.push_slot::<u32>(
            ServerVersionCmd::VT_CHECK_SERVER_INTERVAL,
            check_server_interval,
            0,
        );
    }
    ...
    pub fn add_server_id(&mut self, server_id: i32) {
        self.fbb_
            .push_slot::<i32>(ServerVersionCmd::VT_SERVER_ID, server_id, 0);
    }
    #[inline]
    pub fn add_server_time_utc(&mut self, server_time_utc: u64) {
        self.fbb_
            .push_slot::<u64>(ServerVersionCmd::VT_SERVER_TIME_UTC, server_time_utc, 0);
    }
    #[inline]
    pub fn add_server_time(&mut self, server_time: u64) {
        self.fbb_
            .push_slot::<u64>(ServerVersionCmd::VT_SERVER_TIME, server_time, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> ServerVersionCmdBuilder<'a, 'b, A> {
...
impl<'a> ClientLoginReq<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.os_version {
            builder.add_os_version(x);
        }
        if let Some(x) = args.unk_empty_string_8 {
            builder.add_unk_empty_string_8(x);
        }
        if let Some(x) = args.unk_hex_2 {
            builder.add_unk_hex_2(x);
        }
        if let Some(x) = args.unk_hex {
            builder.add_unk_hex(x);
        }
        if let Some(x) = args.client_wan_ip {
            builder.add_client_wan_ip(x);
        }
        if let Some(x) = args.unk_empty_string_5 {
            builder.add_unk_empty_string_5(x);
        }
        if let Some(x) = args.unk_related_to_uid {
            builder.add_unk_related_to_uid(x);
        }
        if let Some(x) = args.unk_empty_string_3 {
            builder.add_unk_empty_string_3(x);
        }
        if let Some(x) = args.game_id {
            builder.add_game_id(x);
        }
        ...
        if let Some(x) = args.client_version {
            builder.add_client_version(x);
        }
        builder.finish()
    }
    ...
    pub fn client_version(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientLoginReq::VT_CLIENT_VERSION, None)
        }
    }
    #[inline]
    pub fn username(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientLoginReq::VT_USERNAME, None)
        }
    }
    #[inline]
    pub fn password(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientLoginReq::VT_PASSWORD, None)
        }
    }
    #[inline]
    pub fn auth_type(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(ClientLoginReq::VT_AUTH_TYPE, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn unk_empty_string(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                ClientLoginReq::VT_UNK_EMPTY_STRING,
                None,
            )
        }
    }
    ...
    pub fn game_id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientLoginReq::VT_GAME_ID, None)
        }
    }
    #[inline]
    pub fn unk_empty_string_3(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                ClientLoginReq::VT_UNK_EMPTY_STRING_3,
                None,
            )
        }
    }
    ...
    pub fn unk_related_to_uid(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                ClientLoginReq::VT_UNK_RELATED_TO_UID,
                None,
            )
        }
    }
    ...
    pub fn unk_empty_string_5(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                ClientLoginReq::VT_UNK_EMPTY_STRING_5,
                None,
            )
        }
    }
    ...
    pub fn client_wan_ip(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientLoginReq::VT_CLIENT_WAN_IP, None)
        }
    }
    #[inline]
    pub fn unk_hex(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientLoginReq::VT_UNK_HEX, None)
        }
    }
    #[inline]
    pub fn unk_hex_2(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientLoginReq::VT_UNK_HEX_2, None)
        }
    }
    #[inline]
    pub fn unk_empty_string_8(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                ClientLoginReq::VT_UNK_EMPTY_STRING_8,
                None,
            )
        }
    }
    ...
    pub fn os_version(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientLoginReq::VT_OS_VERSION, None)
        }
    }
}
...
impl flatbuffers::Verifiable for ClientLoginReq<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "unk_empty_string_3",
                Self::VT_UNK_EMPTY_STRING_3,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "unk_related_to_uid",
                Self::VT_UNK_RELATED_TO_UID,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "unk_empty_string_5",
                Self::VT_UNK_EMPTY_STRING_5,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "client_wan_ip",
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ClientLoginReqBuilder<'a, 'b, A> {
    ...
    pub fn add_client_version(&mut self, client_version: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            ClientLoginReq::VT_CLIENT_VERSION,
            client_version,
        );
    }
    #[inline]
    pub fn add_username(&mut self, username: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ClientLoginReq::VT_USERNAME, username);
    }
    #[inline]
    pub fn add_password(&mut self, password: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ClientLoginReq::VT_PASSWORD, password);
    }
    #[inline]
    pub fn add_auth_type(&mut self, auth_type: i32) {
        self.fbb_
            .push_slot::<i32>(ClientLoginReq::VT_AUTH_TYPE, auth_type, 0);
    }
    #[inline]
    ...
    pub fn add_game_id(&mut self, game_id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ClientLoginReq::VT_GAME_ID, game_id);
    }
    #[inline]
    ...
    pub fn add_client_wan_ip(&mut self, client_wan_ip: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            ClientLoginReq::VT_CLIENT_WAN_IP,
            client_wan_ip,
        );
    }
    #[inline]
    pub fn add_unk_hex(&mut self, unk_hex: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ClientLoginReq::VT_UNK_HEX, unk_hex);
    }
    #[inline]
    pub fn add_unk_hex_2(&mut self, unk_hex_2: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ClientLoginReq::VT_UNK_HEX_2, unk_hex_2);
    }
    #[inline]
...
impl<'a> ClientTravelCmd<'a> {
    ...
    pub const VT_SAVE_INFO: flatbuffers::VOffsetT = 10;
    pub const VT_SERVER_ADDR: flatbuffers::VOffsetT = 12;
    pub const VT_UNK_EMPTY_STRING_2: flatbuffers::VOffsetT = 14;
    pub const VT_UNK_EMPTY_STRING_3: flatbuffers::VOffsetT = 16;
    pub const VT_PLAYER_ROLE_ID: flatbuffers::VOffsetT = 18;
    pub const VT_PLAYER_CHARACTER_BP: flatbuffers::VOffsetT = 20;
    pub const VT_COMPRESSED_DATA_BLOB: flatbuffers::VOffsetT = 22;
    pub const VT_UNK_322: flatbuffers::VOffsetT = 24;
    pub const VT_UNK_1: flatbuffers::VOffsetT = 26;
    pub const VT_CLEAR_PREVIOUS_STATE: flatbuffers::VOffsetT = 28;
    pub const VT_UNK_CDCDCDCD: flatbuffers::VOffsetT = 30;
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.compressed_data_blob {
            builder.add_compressed_data_blob(x);
        }
        if let Some(x) = args.player_character_bp {
            builder.add_player_character_bp(x);
        }
        if let Some(x) = args.unk_empty_string_3 {
            builder.add_unk_empty_string_3(x);
        }
        if let Some(x) = args.unk_empty_string_2 {
            builder.add_unk_empty_string_2(x);
        }
        if let Some(x) = args.server_addr {
            builder.add_server_addr(x);
        }
        if let Some(x) = args.save_info {
            builder.add_save_info(x);
        }
        if let Some(x) = args.unk_empty_string {
            builder.add_unk_empty_string(x);
        }
        if let Some(x) = args.player_uid {
            builder.add_player_uid(x);
        }
        builder.add_clear_previous_state(args.clear_previous_state);
        builder.finish()
    }

    #[inline]
    pub fn unk_131644(&self) -> u64 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<u64>(ClientTravelCmd::VT_UNK_131644, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn player_uid(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientTravelCmd::VT_PLAYER_UID, None)
        }
    }
    #[inline]
    pub fn unk_empty_string(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                ClientTravelCmd::VT_UNK_EMPTY_STRING,
                None,
            )
        }
    }
    #[inline]
    pub fn save_info(&self) -> Option<&'a str> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientTravelCmd::VT_SAVE_INFO, None)
        }
    }
    #[inline]
    pub fn server_addr(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ClientTravelCmd::VT_SERVER_ADDR, None)
        }
    }
    #[inline]
    pub fn unk_empty_string_2(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                ClientTravelCmd::VT_UNK_EMPTY_STRING_2,
                None,
            )
        }
    }
    ...
    pub fn unk_empty_string_3(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                ClientTravelCmd::VT_UNK_EMPTY_STRING_3,
                None,
            )
        }
    }
    #[inline]
    pub fn player_role_id(&self) -> u64 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<u64>(ClientTravelCmd::VT_PLAYER_ROLE_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn player_character_bp(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                ClientTravelCmd::VT_PLAYER_CHARACTER_BP,
                None,
            )
        }
    }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                    ClientTravelCmd::VT_COMPRESSED_DATA_BLOB,
                    None,
                )
        }
    }
    ...
    pub fn unk_322(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(ClientTravelCmd::VT_UNK_322, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn unk_1(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(ClientTravelCmd::VT_UNK_1, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn clear_previous_state(&self) -> bool {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<bool>(ClientTravelCmd::VT_CLEAR_PREVIOUS_STATE, Some(true))
                .unwrap()
        }
    }
    #[inline]
    pub fn unk_cdcdcdcd(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(ClientTravelCmd::VT_UNK_CDCDCDCD, Some(0))
                .unwrap()
        }
    }
}
...
impl flatbuffers::Verifiable for ClientTravelCmd<'_> {
    ...
    fn run_verifier(
        ...
        use self::flatbuffers::Verifiable;
        v.visit_table(pos)?
            .visit_field::<u64>("unk_131644", Self::VT_UNK_131644, false)?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "player_uid",
                Self::VT_PLAYER_UID,
                false,
            ...
            .visit_field::<u64>("player_role_id", Self::VT_PLAYER_ROLE_ID, false)?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "player_character_bp",
                Self::VT_PLAYER_CHARACTER_BP,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(
                "compressed_data_blob",
                Self::VT_COMPRESSED_DATA_BLOB,
                false,
            )?
            .visit_field::<i32>("unk_322", Self::VT_UNK_322, false)?
            .visit_field::<i32>("unk_1", Self::VT_UNK_1, false)?
            .visit_field::<bool>("clear_previous_state", Self::VT_CLEAR_PREVIOUS_STATE, false)?
...
pub struct ClientTravelCmdArgs<'a> {
    ...
    pub unk_empty_string: Option<flatbuffers::WIPOffset<&'a str>>,
    pub save_info: Option<flatbuffers::WIPOffset<&'a str>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ClientTravelCmdBuilder<'a, 'b, A> {
    #[inline]
    pub fn add_unk_131644(&mut self, unk_131644: u64) {
        self.fbb_
            .push_slot::<u64>(ClientTravelCmd::VT_UNK_131644, unk_131644, 0);
    }
    #[inline]
    pub fn add_player_uid(&mut self, player_uid: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            ClientTravelCmd::VT_PLAYER_UID,
            player_uid,
        );
    }
    #[inline]
    ...
    #[inline]
    pub fn add_save_info(&mut self, save_info: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            ClientTravelCmd::VT_SAVE_INFO,
            save_info,
        );
    }
    #[inline]
    pub fn add_server_addr(&mut self, server_addr: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            ClientTravelCmd::VT_SERVER_ADDR,
            server_addr,
        );
    }
    #[inline]
    ...
    #[inline]
    pub fn add_player_role_id(&mut self, player_role_id: u64) {
        self.fbb_
            .push_slot::<u64>(ClientTravelCmd::VT_PLAYER_ROLE_ID, player_role_id, 0);
    }
    #[inline]
    pub fn add_player_character_bp(
        &mut self,
        player_character_bp: flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            ClientTravelCmd::VT_PLAYER_CHARACTER_BP,
            player_character_bp,
    ...
    #[inline]
    pub fn add_compressed_data_blob(
        &mut self,
        compressed_data_blob: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            ClientTravelCmd::VT_COMPRESSED_DATA_BLOB,
            compressed_data_blob,
    ...
    pub fn add_unk_322(&mut self, unk_322: i32) {
        self.fbb_
            .push_slot::<i32>(ClientTravelCmd::VT_UNK_322, unk_322, 0);
    }
    #[inline]
    pub fn add_unk_1(&mut self, unk_1: i32) {
        self.fbb_
            .push_slot::<i32>(ClientTravelCmd::VT_UNK_1, unk_1, 0);
    }
    #[inline]
    pub fn add_clear_previous_state(&mut self, clear_previous_state: bool) {
        self.fbb_.push_slot::<bool>(
            ClientTravelCmd::VT_CLEAR_PREVIOUS_STATE,
    ...
    pub fn add_unk_cdcdcdcd(&mut self, unk_cdcdcdcd: u32) {
        self.fbb_
            .push_slot::<u32>(ClientTravelCmd::VT_UNK_CDCDCDCD, unk_cdcdcdcd, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> ClientTravelCmdBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
...
impl core::fmt::Debug for ClientTravelCmd<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        ds.field("unk_empty_string", &self.unk_empty_string());
        ds.field("save_info", &self.save_info());
        ...
        ds.field("clear_previous_state", &self.clear_previous_state());
...
impl<'a> ClientKeepAliveCmd<'a> {
    ...
    pub fn unk_1(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(ClientKeepAliveCmd::VT_UNK_1, Some(0))
                .unwrap()
        }
    }
}
...
impl<'a> Default for ClientKeepAliveCmdArgs {
    #[inline]
    fn default() -> Self {
        ClientKeepAliveCmdArgs { unk_1: 0 }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ClientKeepAliveCmdBuilder<'a, 'b, A> {
    ...
    pub fn add_unk_1(&mut self, unk_1: u32) {
        self.fbb_
            .push_slot::<u32>(ClientKeepAliveCmd::VT_UNK_1, unk_1, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> ClientKeepAliveCmdBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
